  ...
  const DICTIONARY = {
    vi: {
      ...
      chat: {
        ...
        input_placeholder: 'Nhập tin nhắn... (Shift + Enter để xuống dòng, Enter để gửi)',
      ...
      modals: {
        ...
        donate_open: 'Mở',
        donate_momo_badge: 'Quét mã bằng app MoMo',
        donate_momo_hint: 'Mở app MoMo để quét mã',
    ...
    en: {
      ...
      chat: {
        ...
        input_placeholder: 'Type a message... (Shift + Enter for new line, Enter to send)',
      ...
      modals: {
        ...
        donate_open: 'Open',
        donate_momo_badge: 'Scan with MoMo App',
        donate_momo_hint: 'Open MoMo app to scan QR',
